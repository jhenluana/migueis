...
export default function ScrollableTabsButtonAuto() {
  ...
  const excluiComanda = (id) => {
    console.log(id)
    const novaComanda = comanda.map(p => {
      if(p.item === id && p.qtd>0){
        const nqtd = p.qtd - 1
        return {...p, qtd:nqtd}
      }
      // return {...p}
  ...
  const getQtd = (id) => {
    const tmp = comanda.filter(p => (p.item === id) )
      console.log(tmp.qtd);
      // return tmp
  }
  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <Produtos getQuantidade={getQtd} addComanda={incluiComanda} remComanda={excluiComanda} data={filterCardapio("peixes")} />
      </TabPanel>
      <TabPanel value={value} index={1}>
        <Produtos getQuantidade={getQtd} addComanda={incluiComanda} remComanda={excluiComanda} data={filterCardapio("massas")} />
      </TabPanel>
      <TabPanel value={value} index={2}>
        <Produtos getQuantidade={getQtd} addComanda={incluiComanda} remComanda={excluiComanda} data={filterCardapio("petiscos")} />
      </TabPanel>
      <TabPanel value={value} index={3}>
        <Produtos getQuantidade={getQtd} addComanda={incluiComanda} remComanda={excluiComanda} data={filterCardapio("carnes")} />
      </TabPanel>
      <TabPanel value={value} index={4}>
        <Produtos getQuantidade={getQtd} addComanda={incluiComanda} remComanda={excluiComanda} data={filterCardapio("frango")} />
      </TabPanel>
      <TabPanel value={value} index={5}>
        <Produtos getQuantidade={getQtd} addComanda={incluiComanda} remComanda={excluiComanda} data={filterCardapio("jacare")} />
      </TabPanel>
      <TabPanel value={value} index={6}>
        <Produtos getQuantidade={getQtd} addComanda={incluiComanda} remComanda={excluiComanda} data={filterCardapio("saladas")} />
      </TabPanel>
      <TabPanel value={value} index={7}>
        <Produtos getQuantidade={getQtd} addComanda={incluiComanda} remComanda={excluiComanda} data={filterCardapio("sobremesa")} />
      </TabPanel>
      <TabPanel value={value} index={8}>
        <Produtos getQuantidade={getQtd} addComanda={incluiComanda} remComanda={excluiComanda} data={filterCardapio("drinks")} />
      </TabPanel>
    </div>
  );
}
