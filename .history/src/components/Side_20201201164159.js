...
export default function ScrollableTabsButtonAuto() {
  ...
  const incluiComanda = (id) => {
    ...
    localStorage.setItem("comanda",JSON.stringify(novaComanda));
  }
  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <Produtos addComanda={incluiComanda} data={filterCardapio("peixes")} />
      </TabPanel>
      <TabPanel value={value} index={1}>
        <Produtos addComanda={incluiComanda} data={filterCardapio("massas")} />
      </TabPanel>
      <TabPanel value={value} index={2}>
        <Produtos addComanda={incluiComanda} data={filterCardapio("petiscos")} />
      </TabPanel>
      <TabPanel value={value} index={3}>
        <Produtos addComanda={incluiComanda} data={filterCardapio("carnes")} />
      </TabPanel>
      <TabPanel value={value} index={4}>
        <Produtos addComanda={incluiComanda} data={filterCardapio("frango")} />
      </TabPanel>
      <TabPanel value={value} index={5}>
        <Produtos addComanda={incluiComanda} data={filterCardapio("jacare")} />
      </TabPanel>
      <TabPanel value={value} index={6}>
        <Produtos addComanda={incluiComanda} data={filterCardapio("saladas")} />
      </TabPanel>
      <TabPanel value={value} index={7}>
        <Produtos addComanda={incluiComanda} data={filterCardapio("sobremesa")} />
      </TabPanel>
      <TabPanel value={value} index={8}>
        <Produtos addComanda={incluiComanda} data={filterCardapio("drinks")} />
      </TabPanel>
    </div>
  );
}
